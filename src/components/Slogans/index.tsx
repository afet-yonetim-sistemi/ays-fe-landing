...
const Slogans: JSX.Element[] = SlogansData.map((slogan, index) => {
    ...
    return <div id="slogan" key={index}
                className={clsx('flex flex-col w-auto items-start justify-center gap-2 h-full m-auto text-3xl sm:text-4xl md:text-6xl font-black text-background', montserrat.className)}>
